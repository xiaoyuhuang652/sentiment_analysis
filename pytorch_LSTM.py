...
class LSTMClassifier(nn.Module):
    def __init__(self, vocab_size, embed_dim=256, hidden_dim=256, num_layers=2, dropout=0.3):
        ...
        self.fc = nn.Linear(hidden_dim*2, 2)  # bidirectional -> hidden*2
    ...
    def forward(self, x):
        ...
        # final = h_n[-1]          # [batch, hidden_dim]
        final = out.mean(dim=1)  # [batch, hidden*2] if bidirectional
...
plt.grid()
plt.savefig("results/LSTM training_curves.png")
plt.show()